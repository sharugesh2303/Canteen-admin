...
// Changed from 10000 to 5000 to match the local server setup
// ================================================
...
const getFullImageUrl = (imagePath) => {
    ...
    // Check if the path is already a full URL (Cloudinary starts with http)
